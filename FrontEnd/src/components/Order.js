  ...
  constructor(props) {
    ...
    this.state = {
      ...
      forms: [
        ...
        <Confirmation incrementPage={this.incrementPage} setState={this.updateState} completeForm={this.completeForm}
    ...
    if (newCurrent >= 2) {
      this.setState({
        forms: [
          <FromTo incrementPage={this.incrementPage} setState={this.updateState} />,
          <PaymentInfo incrementPage={this.incrementPage} setState={this.updateState} />,
          <Confirmation incrementPage={this.incrementPage} setState={this.updateState} completeForm={this.completeForm} order={this.state.Order}
           orderId={this.state.orderId} droneOrRobot={this.state.droneOrRobot}/>
        ]
      });
      console.log('>=2')
    }
